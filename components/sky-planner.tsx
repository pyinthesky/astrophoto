...
import { ArrowRight, CalendarClock, Clock3, Compass, LocateFixed, MapPin, Moon, ShieldCheck, Sparkles, SunMoon } from "lucide-react";
  ...
  return (
    <main>
      ...
      <section className="planner-shell">
        ...
        <section className="planner-controls" aria-label="Sky planner settings">
          <div className="location-control">
            ...
            <p className="privacy-note"><ShieldCheck size={14} /> Your coordinates are used only in this page and are never uploaded or saved.</p>
          </div>
      ...
      <footer>
        ...
        <p>Milky Way visibility depends on weather, light pollution, atmospheric clarity, and local obstructions.</p>
      </footer>
    </main>
  );
}
